...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { context: @discussion.context, headline: @discussion.headline } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { context: @discussion.context, headline: @discussion.headline } }
